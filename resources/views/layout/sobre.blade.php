...
<body>  
    ...
    <div class="ajustes">
        <div class="espaco " style="height: 40px">
            <h1> Sobre </h1>
            <span class="vc_empty_space_inner">

                <p>Esse software foi criado com intencao de ajudar a  .....</p>
                <p>É visto que a questão das rotinas administrativas foi desenvolvida para ter uma melhor gerência de medicamento e material
        ...
        <div class="espaco2 " style="height: 40px">
            <h1> História </h1>
            <span class="vc_empty_space_inner">
    ...
    <div class="  barra  ">
        ...
        class="vc_custom_heading">Missão</h3>
        <p>Trazer para dentro das organizacões que realizam exames Diagnosticos, facilidade e rapidez em suas Prescricão Médica, alem de solucionar problemas presentes na gestão de medicamentos e materiais.  </p>
        </div>

        <div class="visao ">
            <h3 style="font-size: 36px; text-align: center;font-family:Dosis;font-style:normal" 
            class="vc_custom_heading">Visão</h3>
            <p>Ser até 2025, um dos softwares mais populares em gestao de administracao de medicamento e materiais, caracterizado pela resposabilidade e organização visando o cresminto e a melhor de funcionalidades e componetes.</p>
        </div>
