...
<div class="  barra  ">
    ...
    <p>Trazer para dentro das organizacões que realizam exames Diagnósticos, facilidade e rapidez em suas Prescrição Médica, além de trazer a possibilidade de solucionar problemas presentes na gestão de medicamentos e materiais.  </p>
    </div>

    <div class="visao ">
        <h3 style="font-size: 36px; text-align: center;font-family:Dosis;font-style:normal" 
        class="vc_custom_heading">Visão</h3>
        <p>Ser até 2025, um dos softwares mais populares em gestão de administração de medicamentos e materiais, caracterizado pela resposabilidade e organização visando o crescimento e o desenvolvimento de outras funcionalidades e componetes.</p>
    </div>
