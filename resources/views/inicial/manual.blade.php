...
<div class="texto">
    <div >
        ...
        <span class="vc_empty_space_inner">
            ...
            <p>Ao  usuário realizar seu cadastro, é redirecionado à página inicial do sistema com algumas informações iniciais intuitivas, podendo acessar links que redirecionam para os sites com informações que podem ser lidas sobre o tópico escolhido.  </p>
            ...
            <p> Já na tela de Realizar Prescrição Médica é possível o profissional adicionar todos as informações necessárias sobre o que foi utilizado na realização do exame, além de conter os dados dos medicamentos e materiais que foram utilizados. 
                Possui campos para inserir dados do paciente, convênio, data de realização do exame, observação no qual é inserido, como foi realizado o exame  e quais medicamentos e materiais foram utilizados, entre outras informações necessárias que o profissional precisa adicionar. </p>
