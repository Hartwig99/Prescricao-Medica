    ...
    @csrf
        ...
        <div class=" form-row texto ">
            ...
            <div class="w3-border-bottom">
                <p style="margin-top: 5%; font-weight:bold;">Para melhor atender ao cidadão que deseja consultar o preço máximo em que pode adquirir medicamentos nas farmácias e drogarias, 
            ...
            <div class="form-row bg-success cadastro" >
                ...
                <button type="submit" class="btn  botao" onclick="return confirm('Deseja realmente cadastrar o medicamento?');">Cadastrar <img class="adicionar" src="/img/adicionar.png"/></button>
            </div>
